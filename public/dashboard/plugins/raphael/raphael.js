...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * Parses colour string as RGB object
     ...
     # <ul>
     #     <li>Colour name (“<shareCode>red</shareCode>”, “<shareCode>green</shareCode>”, “<shareCode>cornflowerblue</shareCode>”, etc)</li>
     #     <li>#••• — shortened HTML colour: (“<shareCode>#000</shareCode>”, “<shareCode>#fc0</shareCode>”, etc)</li>
     #     <li>#•••••• — full length HTML colour: (“<shareCode>#000000</shareCode>”, “<shareCode>#bd2300</shareCode>”)</li>
     #     <li>rgb(•••, •••, •••) — red, green and blue channels’ values: (“<shareCode>rgb(200,&nbsp;100,&nbsp;0)</shareCode>”)</li>
     #     <li>rgb(•••%, •••%, •••%) — same as above, but in %: (“<shareCode>rgb(100%,&nbsp;175%,&nbsp;0%)</shareCode>”)</li>
     #     <li>hsb(•••, •••, •••) — hue, saturation and brightness values: (“<shareCode>hsb(0.5,&nbsp;0.25,&nbsp;1)</shareCode>”)</li>
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     * at 0.25, 0.75. Focus point coordinates are in 0..1 range. Radial gradients can only be applied to circles and ellipses.
     ...
     #     <li>rgb(•••, •••, •••) — red, green and blue channels’ values: (“<shareCode>rgb(200,&nbsp;100,&nbsp;0)</shareCode>”)</li>
     #     <li>rgb(•••%, •••%, •••%) — same as above, but in %: (“<shareCode>rgb(100%,&nbsp;175%,&nbsp;0%)</shareCode>”)</li>
     #     <li>rgba(•••, •••, •••, •••) — red, green and blue channels’ values: (“<shareCode>rgba(200,&nbsp;100,&nbsp;0, .5)</shareCode>”)</li>
     #     <li>rgba(•••%, •••%, •••%, •••%) — same as above, but in %: (“<shareCode>rgba(100%,&nbsp;175%,&nbsp;0%, 50%)</shareCode>”)</li>
     #     <li>hsb(•••, •••, •••) — hue, saturation and brightness values: (“<shareCode>hsb(0.5,&nbsp;0.25,&nbsp;1)</shareCode>”)</li>
     #     <li>hsb(•••%, •••%, •••%) — same as above, but in %</li>
     ...
     #     <li>Optionally for hsb and hsl you could specify hue as a degree: “<shareCode>hsl(240deg,&nbsp;1,&nbsp;.5)</shareCode>” or, if you want to go fancy, “<shareCode>hsl(240°,&nbsp;1,&nbsp;.5)</shareCode>”</li>
     # </ul>
    \*/
