...
var Constraints = /** @class */ (function () {
    ...
    */
    ...
    // ------------------------------------------------------------------------------------------------
    // NOTE: this might seem like repetitive shareCode with the Grid class, however, this shareCode is related to
    // constraints whereas the Grid shareCode is related to rendering. Each approach might want to convert
...
var Popover = /** @class */ (function () {
    ...
    // Triggers a callback. Calls a function in the option hash of the same name.
    // Arguments beyond the first `name` are forwarded on.
    // TODO: better shareCode reuse for this. Repeat shareCode
