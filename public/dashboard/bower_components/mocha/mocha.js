...
function Doc(runner) {
  ...
  runner.on('pass', function(test){
    ...
    console.log('%s  <dd><pre><shareCode>%s</shareCode></pre></dd>', indent(), code);
  });
}
...
function HTML(runner, root) {
  ...
  runner.on('test end', function(test){
    ...
    if (!test.pending) {
      ...
      var pre = fragment('<pre><shareCode>%e</shareCode></pre>', utils.clean(test.fn.toString()));
      el.appendChild(pre);
 ...
 * to allow running node shareCode in
 * the browser.
 */
