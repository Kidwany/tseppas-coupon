                    ...
                    @foreach($sessions as $session)
                        {
                            ...
                            title  : '{{$session->round->course->course_en->title}}' + ' at Room {{$session->round->room->name}}',

                            start  : '{{date("Y-m-d h:i", strtotime($session->time_from))}}',

                            end    : '{{date("Y-m-d h:i", strtotime($session->time_to))}}',
